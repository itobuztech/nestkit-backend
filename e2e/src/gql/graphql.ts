...
export type GetPostListQuery = { __typename?: 'Query', getPostList: { __typename?: 'PostListResponse', posts: Array<{ __typename?: 'PostResponse', title: string, content: string, id: string, published: boolean, createdAt: any, updatedAt: any, deletedAt?: any | null, author: { __typename?: 'PostAuthor', id: string, name: string } }>, pagination: { __typename?: 'BaseListResponse', totalPage: number, currentPage: number, perPage: number } } };
...
export type RoleListQuery = { __typename?: 'Query', roleList: { __typename?: 'RoleListResponse', role: Array<{ __typename?: 'RoleResponse', title: string, type: string, id: string, deletedAt?: any | null }>, pagination: { __typename?: 'BaseListResponse', totalPage: number, currentPage: number, perPage: number } } };
...
export type GetRoleQuery = { __typename?: 'Query', getRole: { __typename?: 'RoleGetResponse', id: string, title: string, type: string, createdAt: any, updatedAt: any, deletedAt?: any | null, privilege: Array<{ __typename?: 'RolePrivilegeResponse', name: string, group: string, id: string, type: string }> } };
