...
export type ListMembershipsQuery = { __typename?: 'Query', listMemberships: { __typename?: 'ListMembershipResponse', memberships: Array<{ __typename?: 'MembershipResponse', workspaceId: string, isOwner: boolean, isAccepted: boolean, user: { __typename?: 'User', id: string, name: string } }>, pagination: { __typename?: 'BaseListResponse', totalPage: number, currentPage: number, perPage: number } } };
